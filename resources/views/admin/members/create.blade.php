...
@section('content')
<div class="max-w-2xl">
    <h1 class="text-2xl font-bold text-gray-800 mb-4">Add New Member</h1>
    ...
    <form method="POST" action="{{ route('admin.members.store') }}" class="bg-white rounded-lg shadow p-6 space-y-4">
        ...
        <div class="flex gap-2 pt-4">
            <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded-lg text-sm hover:bg-blue-700">Create Member</button>
