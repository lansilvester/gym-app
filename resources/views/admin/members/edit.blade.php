...
@section('content')
<div class="max-w-2xl">
    <h1 class="text-2xl font-bold text-gray-800 mb-4">Ubah Anggota: {{ $member->user->name }}</h1>
    ...
    <form method="POST" action="{{ route('admin.members.update', $member) }}" class="bg-white rounded-lg shadow p-6 space-y-4">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Kata Sandi Baru <span class="text-gray-400">(biarkan kosong untuk tetap menggunakan yang sekarang)</span></label>
        ...
        <h3 class="font-semibold text-gray-700 border-b pb-2 pt-4">Status Akun</h3>
        ...
        <div class="flex gap-2 pt-4">
            <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded-lg text-sm hover:bg-blue-700">Perbarui Anggota</button>
