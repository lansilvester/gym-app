...
<div class="space-y-4">
    <div class="flex items-center justify-between">
        ...
        <a href="{{ route('admin.members.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 text-sm">+ Add Member</a>
    </div>
        ...
        <table class="w-full text-sm">
            <thead class="bg-gray-50 border-b border-gray-200">
                <tr>
                    ...
                    <th class="px-4 py-3 text-left font-medium text-gray-600">Gender</th>
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3">
                        <a href="{{ route('admin.members.show', $member) }}" class="text-blue-600 hover:underline text-xs">View</a>
                        <a href="{{ route('admin.members.edit', $member) }}" class="text-yellow-600 hover:underline text-xs ml-2">Edit</a>
                    </td>
                </tr>
                @empty
                <tr><td colspan="6" class="px-4 py-8 text-center text-gray-500">No members found</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
