...
@section('content')
<div class="space-y-4">
    <h1 class="text-2xl font-bold text-gray-800">Manajemen Check-in</h1>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        <h3 class="font-semibold text-gray-800 mb-3">Check-in Manual</h3>
    ...
    <div class="bg-white rounded-lg shadow overflow-hidden">
        <div class="px-4 py-3 bg-gray-50 border-b border-gray-200 flex items-center justify-between">
            <h3 class="font-semibold text-gray-800">Check-in Hari Ini ({{ $checkins->count() }})</h3>
            ...
            <tbody class="divide-y divide-gray-100">
                ...
                <tr class="hover:bg-gray-50">
                    ...
                    <td class="px-4 py-3">
                        ...
                        @else
                            <span class="text-yellow-600 font-medium">Masih di dalam</span>
                        @endif
                    </td>
                ...
                @empty
                <tr><td colspan="6" class="px-4 py-8 text-center text-gray-500">Belum ada check-in hari ini</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
