...
@section('content')
<div class="max-w-2xl">
    <h1 class="text-2xl font-bold text-gray-800 mb-4">Edit Langganan</h1>
    ...
    <form method="POST" action="{{ route('admin.subscriptions.update', $subscription) }}" class="bg-white rounded-lg shadow p-6 space-y-4">
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                <label class="block text-sm font-medium text-gray-700 mb-1">Perpanjang Otomatis</label>
                <div class="flex items-center gap-2 pt-1">
                    ...
                    <label class="text-sm text-gray-700">Aktifkan perpanjang otomatis</label>
                </div>
            </div>
            <div>
        ...
        <div class="flex gap-2 pt-4">
            <button type="submit" class="bg-blue-600 text-white px-6 py-2 rounded-lg text-sm hover:bg-blue-700">Perbarui Langganan</button>
            <a href="{{ route('admin.subscriptions.index') }}" class="bg-gray-200 text-gray-700 px-6 py-2 rounded-lg text-sm hover:bg-gray-300">Batal</a>
        </div>
    </form>
</div>
@endsection
